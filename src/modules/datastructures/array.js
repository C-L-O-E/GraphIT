...
var arr= new array(10,'graphView');
//arr.draw();
for (var i = 0; i < 10; i++) {
    var randomNumber = Math.floor(Math.random() * 100) + 1;
    arr.insertAtIndex(randomNumber,i);
  }

  // Call mergeSort() with the appropriate parameters to animate the merge sort
...
//longShiftSwap(5,1);
//insertionSort(arr);
//selectiortMethode(arr);


//array is temporarely taken out <script src="modules/datastructures/array.js"></script>
*/